...
export const config = {
  ...
  matcher: [
    "/((?!login|registrieren|passwort-vergessen|passwort-neu|konto-bestaetigen|passwort-aendern|datenschutz|anleitung|fahrzeug|api/|_next/|favicon.ico|icon.svg|.*\\.webmanifest|sw.js|kiosk-sw.js).*)",
  ],
};
