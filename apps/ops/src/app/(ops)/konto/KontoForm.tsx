...
export function KontoForm() {
  ...
  return (
    <form action={action} className="grid gap-3" style={{ maxWidth: 380 }}>
      ...
      <label className="grid gap-1">
        <span className="lbl">Neues Passwort (min. 12 Zeichen)</span>
        <input name="next" type="password" className="inp" autoComplete="new-password" minLength={12} required />
      </label>
      <label className="grid gap-1">
        <span className="lbl">Neues Passwort wiederholen</span>
        <input name="confirm" type="password" className="inp" autoComplete="new-password" minLength={12} required />
      </label>
