      ...
      <div className="panel mb-4">
        <details>
          ...
          <form action={vorlageAnlegen} className="p-4 border-t border-[color:var(--border)] grid gap-3 sm:grid-cols-2 lg:grid-cols-4 items-end">
            ...
            <div className="field"><label className="lbl">Start ab</label><select name="startLocationId" className="inp"><option value="">—</option>{sd.orte.map((o) => <option key={o.id} value={o.id}>{o.name}</option>)}</select></div>
