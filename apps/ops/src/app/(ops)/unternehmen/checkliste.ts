...
export function checkliste(m: MandantStatus): Punkt[] {
  return [
    ...
    { key: "smtp", titel: "E-Mail-Versand (SMTP) hinterlegt", ok: m.smtp, hinweis: m.smtp ? "eigener Mailserver" : "Ohne eigenes SMTP gehen Mails über die Plattform (Absender CareOS).", href: `/unternehmen/${m.id}?tab=smtp` },
