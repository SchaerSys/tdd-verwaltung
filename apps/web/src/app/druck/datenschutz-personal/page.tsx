    ...
    <div style={{ background: "#fff", color: "#111", minHeight: "100vh" }}>
      ...
      <div className="ds">
        ...
        <ul>
          ...
          <li><b>Fahrdienst:</b> Einteilung zu Touren, gefahrenes Fahrzeug, Kilometerstand, erfasste Mengen je Stopp. Das Fahrzeug-Tablet zeichnet <u>keinen</u> Standortverlauf auf; Navigation läuft in einer separaten App auf dem Tablet.</li>
