...
const KARTEN: Karte[] = [
  ...
  { gruppe: "Klient:innen & Ausgabe", titel: "Monatsbericht (Druck / PDF)", text: "Ausgabe je Ausgabestelle, Klient:innen, Wareneingang, Schulden – für Obmann und Vorstand; Versand am 1. per Mail einstellbar.", href: "/druck/monatsbericht", perm: "report:view" },
